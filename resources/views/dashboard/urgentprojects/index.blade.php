...
@section('title',' إدارة المشاريع العاجلة  ')
@section('dashboard-content')
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{route('dashboard.index')}}">لوحة التحكم</a></li>
      <li class="breadcrumb-item active" aria-current="page"> إدارة المشاريع العاجلة    </li>
    </ol>
    </nav>
    <div class="projects">
      <div class="h5"> إدارة المشاريع العاجلة   </div>
        ...
        <div class="modal-dialog  modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form  id="create-form" enctype="multipart/form-data" method="post" action="{{route('urgentprojects.store')}}">
                @csrf
                @method('POST')
                <div class="form-row">
                  <div class="col">
        ...
        <?php $ids = 0?>
          @foreach ($allprojects as $project)
            ...
            <tr>
              ...
              <td>
                <form class="form-inline" action="{{route('urgentprojects.destroy',$project->projectId) }}" method="post">
                  @csrf
                  @method("DELETE")

                  <a class="btn  btn-sm ml-1" href="{{route('urgentprojects.edit',$project->projectId)}}" ><i class="fa fa-edit "></i></a>
